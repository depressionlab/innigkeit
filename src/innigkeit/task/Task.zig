...
const globals = struct {
    ...
    var kernel_task_cache: innigkeit.mem.cache.Cache(
        Task,
        .{
            .constructor = struct {
                fn constructor(task: *Task) innigkeit.mem.cache.ConstructorError!void {
    ...
    var kernel_tasks_lock: innigkeit.sync.RwLock = .{};
