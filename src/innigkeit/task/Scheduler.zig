...
pub fn queueTask(scheduler: *Scheduler, task: *innigkeit.Task) void {
...
pub fn getNextTask(scheduler: *Scheduler) ?*innigkeit.Task {
...
pub const Handle = struct {
    ...
    pub fn queueTask(scheduler_handle: Handle, task: *innigkeit.Task) void {
        if (core.is_debug) {
