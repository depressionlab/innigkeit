...
pub inline fn prepareToWaitFor(self: ReferenceCounter, duration: core.Duration) void {
...
pub inline fn waitFor(self: ReferenceCounter, duration: core.Duration) void {
