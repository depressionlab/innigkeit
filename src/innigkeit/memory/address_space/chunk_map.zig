...
pub fn ChunkMap(comptime T: type) type {
    return struct {
        ...
        pub fn ensureChunk(self: *@This(), index: u32) std.mem.Allocator.Error!*Chunk {
            const chunk = try self.chunks.getOrPut(innigkeit.memory.heap.allocator, chunkIndex(index));
        ...
        pub fn deinit(self: *@This()) void {
            self.chunks.deinit(innigkeit.memory.heap.allocator);
        }
