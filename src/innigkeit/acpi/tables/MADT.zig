...
pub const MADT = extern struct {
    ...
    pub const InterruptControllerEntry = extern struct {
        ...
        pub const LocalAPICAddressOverride = extern struct {
            ...
            local_apic_address: innigkeit.PhysicalAddress align(1),
        ...
        pub const IOSAPIC = extern struct {
            ...
            iosapic_address: innigkeit.PhysicalAddress align(1),
        ...
        pub const GIC_CPUInterface = extern struct {
            ...
            parked_address: innigkeit.PhysicalAddress align(1),
            ...
            physical_base_address: innigkeit.PhysicalAddress align(1),
            ...
            gicv: innigkeit.PhysicalAddress align(1),

            /// Address of the GIC virtual interface control block registers.
            ///
            /// If the platform is not presenting a GICv2 with virtualization extensions this field can be 0.
            gich: innigkeit.PhysicalAddress align(1),
            ...
            gicr_base_address: innigkeit.PhysicalAddress align(1),
        ...
        pub const GIC_Redistributor = extern struct {
            ...
            discovery_range_base_address: innigkeit.PhysicalAddress align(1),
        ...
        pub const MultiprocessorWakeup = extern struct {
            ...
            mailbox_address: innigkeit.PhysicalAddress align(1),
        ...
        pub const LegacyIOProgrammableInterruptController = extern struct {
            ...
            /// vector field.
            cascade_vector_mapping: innigkeit.PhysicalAddress align(1),
        ...
        pub const HyperTransportProgrammableInterruptController = extern struct {
            ...
            cascade_vector: innigkeit.PhysicalAddress align(1),
        ...
        pub const MSIProgrammableInterruptController = extern struct {
            ...
            message_address: innigkeit.PhysicalAddress align(1),
