...
pub const TPM2 = extern struct {
    ...
    address: innigkeit.PhysicalAddress align(1),
    ...
    _log_area_start_address: innigkeit.PhysicalAddress align(1),
    ...
    pub fn logAreaStartAddress(tpm2: *const TPM2) ?innigkeit.PhysicalAddress {
        if (tpm2.header.length < @offsetOf(TPM2, "_log_area_start_address") + @sizeOf(innigkeit.PhysicalAddress)) return null;
    ...
    pub const StartMethodSpecificParameters = extern union {
        ...
        pub const CommandResponseBufferWithAMDMailbox = extern struct {
            ...
            tpm_start_address: innigkeit.PhysicalAddress align(1),
            ...
            tpm_reply_address: innigkeit.PhysicalAddress align(1),
