...
pub const register_region_size = @import("core").Size.of(u32).multiplyScalar(2);

pub fn init(base_address: @import("innigkeit").KernelVirtualAddress, gsi_base: u32) IOAPIC {
    var ioapic: IOAPIC = .{
