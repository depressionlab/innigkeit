...
pub fn wait(addr: *const u32, expected: u32) innigkeit.Error.Syscall!void {
...
/// after return.
pub fn waitTimeout(addr: *const u32, expected: u32, deadline_ms: u64) innigkeit.Error.Syscall!void {
    const result = innigkeit.Syscall.invoke(
        .futex_wait_timeout,
...
pub fn wake(addr: *const u32, max_wake: u32) innigkeit.Error.Syscall!u32 {
    const result = innigkeit.Syscall.invoke(
        .futex_wake,
